...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AuthorLink.link_type'
        db.alter_column('blogit_author_links', 'link_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'AuthorLink.link_type'
        db.alter_column('blogit_author_links', 'link_type', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'blogit.category': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 10, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 10, 0, 0)'})
        },
