...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('blogit_posts', 'date_created', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'AuthorLink.url'
        db.alter_column('blogit_author_links', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Post.date_created'
        db.alter_column('blogit_posts', 'date_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'AuthorLink.url'
        db.alter_column('blogit_author_links', 'url', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'blogit.post': {
            'Meta': {'ordering': "('-date_created',)", 'object_name': 'Post', 'db_table': "'blogit_posts'"},
