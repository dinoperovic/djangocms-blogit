...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PostTranslation.is_public'
        db.add_column('blogit_posts_translation', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Post.is_public'
        db.delete_column('blogit_posts', 'is_public')


    def backwards(self, orm):
        # Deleting field 'PostTranslation.is_public'
        db.delete_column('blogit_posts_translation', 'is_public')

        # Adding field 'Post.is_public'
        db.add_column('blogit_posts', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
