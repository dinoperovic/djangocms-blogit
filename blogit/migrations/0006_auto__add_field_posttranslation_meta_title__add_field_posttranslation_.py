...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blogit_posts_translation', 'meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostTranslation.meta_description'
        db.add_column('blogit_posts_translation', 'meta_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostTranslation.meta_keywords'
        db.add_column('blogit_posts_translation', 'meta_keywords',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('blogit_posts_translation', 'meta_title')

        # Deleting field 'PostTranslation.meta_description'
        db.delete_column('blogit_posts_translation', 'meta_description')

        # Deleting field 'PostTranslation.meta_keywords'
        db.delete_column('blogit_posts_translation', 'meta_keywords')
