...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blogit_posts', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogit.Category'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field categories on 'Post'
        db.delete_table(db.shorten_name('blogit_posts_categories'))


    def backwards(self, orm):
        # Deleting field 'Post.category'
        db.delete_column('blogit_posts', 'category_id')

        # Adding M2M table for field categories on 'Post'
        m2m_table_name = db.shorten_name('blogit_posts_categories')
