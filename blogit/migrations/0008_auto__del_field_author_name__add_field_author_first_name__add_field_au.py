...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('blogit_authors', 'name')

        # Adding field 'Author.first_name'
        db.add_column('blogit_authors', 'first_name',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Author.last_name'
        db.add_column('blogit_authors', 'last_name',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Author.email'
        db.add_column('blogit_authors', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Author.slug'
        db.alter_column('blogit_authors', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Author.name'
        db.add_column('blogit_authors', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=255),
                      keep_default=False)

        # Deleting field 'Author.first_name'
        db.delete_column('blogit_authors', 'first_name')

        # Deleting field 'Author.last_name'
        db.delete_column('blogit_authors', 'last_name')

        # Deleting field 'Author.email'
        db.delete_column('blogit_authors', 'email')


        # User chose to not deal with backwards NULL issues for 'Author.slug'
        raise RuntimeError("Cannot reverse this migration. 'Author.slug' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Author.slug'
        db.alter_column('blogit_authors', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255))
    ...
    models = {
        ...
        u'blogit.post': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['blogit.Category']", 'null': 'True', 'blank': 'True'}),
