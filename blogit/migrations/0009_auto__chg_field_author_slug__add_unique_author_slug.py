...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('blogit_authors', 'slug', self.gf('django.db.models.fields.SlugField')(default=datetime.datetime(2014, 1, 16, 0, 0), unique=True, max_length=100))
        # Adding unique constraint on 'Author', fields ['slug']
        db.create_unique('blogit_authors', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Author', fields ['slug']
        db.delete_unique('blogit_authors', ['slug'])
