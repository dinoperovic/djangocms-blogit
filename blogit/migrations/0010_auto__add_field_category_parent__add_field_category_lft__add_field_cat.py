...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blogit_categories', 'parent',
                      self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['blogit.Category']),
                      keep_default=False)

        # Adding field 'Category.lft'
        db.add_column('blogit_categories', 'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding field 'Category.rght'
        db.add_column('blogit_categories', 'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding field 'Category.tree_id'
        db.add_column('blogit_categories', 'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding field 'Category.level'
        db.add_column('blogit_categories', 'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('blogit_categories', 'parent_id')

        # Deleting field 'Category.lft'
        db.delete_column('blogit_categories', 'lft')

        # Deleting field 'Category.rght'
        db.delete_column('blogit_categories', 'rght')

        # Deleting field 'Category.tree_id'
        db.delete_column('blogit_categories', 'tree_id')

        # Deleting field 'Category.level'
        db.delete_column('blogit_categories', 'level')
