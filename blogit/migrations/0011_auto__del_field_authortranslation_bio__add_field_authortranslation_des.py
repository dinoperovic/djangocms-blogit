...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AuthorTranslation.bio'
        db.delete_column('blogit_authors_translation', 'bio')

        # Adding field 'AuthorTranslation.description'
        db.add_column('blogit_authors_translation', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Post.category'
        db.alter_column('blogit_posts', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogit.Category'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Post.author'
        db.alter_column('blogit_posts', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogit.Author'], null=True, on_delete=models.SET_NULL))
        # Adding field 'Author.bio'
        db.add_column('blogit_authors', 'bio',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AuthorTranslation.bio'
        db.add_column('blogit_authors_translation', 'bio',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'AuthorTranslation.description'
        db.delete_column('blogit_authors_translation', 'description')


        # Changing field 'Post.category'
        db.alter_column('blogit_posts', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogit.Category'], null=True))

        # Changing field 'Post.author'
        db.alter_column('blogit_posts', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogit.Author'], null=True))
        # Deleting field 'Author.bio'
        db.delete_column('blogit_authors', 'bio_id')
    ...
    models = {
        ...
        u'blogit.category': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': u"orm['blogit.Category']"}),
        ...
        u'blogit.post': {
            'Meta': {'ordering': "('-date_published',)", 'object_name': 'Post', 'db_table': "'blogit_posts'"},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['blogit.Author']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['blogit.Category']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
