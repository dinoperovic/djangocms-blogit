...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blogit_tagged_post_translations', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tagged_posts', to=orm['blogit.Tag'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('blogit_tagged_post_translations')

        # Deleting model 'Tag'
        db.delete_table('blogit_tags')
    ...
    models = {
        ...
        u'blogit.tag': {
            'Meta': {'object_name': 'Tag', 'db_table': "'blogit_tags'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '100'})
        },
        u'blogit.taggedpost': {
            'Meta': {'object_name': 'TaggedPost', 'db_table': "'blogit_tagged_post_translations'"},
            'content_object': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['blogit.PostTranslation']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tagged_posts'", 'to': u"orm['blogit.Tag']"})
        },
        'cms.placeholder': {
