...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'blogit_posts', 'category_id', self.gf('mptt.fields.TreeForeignKey')(to=orm['blogit.Category'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Post.category'
        db.alter_column(u'blogit_posts', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogit.Category'], null=True, on_delete=models.SET_NULL))
    ...
    models = {
        ...
        u'blogit.post': {
            'Meta': {'object_name': 'Post', 'db_table': "u'blogit_posts'"},
